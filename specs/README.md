...
4. ~~**Diseñar los íconos** 192, 512 y `maskable-512` a partir de la marca "C ChemLab".~~ **Hecho:** tubo de ensayo con líquido, acento violeta sobre `--surface-1`, zona segura maskable. (SPEC 18 §2)
5. ~~**Descargar y subsetear las fuentes** Space Grotesk y IBM Plex Mono a `woff2`.~~ **Hecho:** 7 archivos autoalojados en `public/fonts/`, subconjunto latino. (SPEC 14 §4)
